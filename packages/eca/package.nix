...
if pkgs.stdenv.hostPlatform.system == "x86_64-linux" then
  ...
  mkNativeBinary {
    ...
    hash = "sha256-F0IcrurZegICs3zMAlU+FR8DfOHVmSO2uEXYg+exjTE=";
  }
  ...
  mkNativeBinary {
    ...
    hash = "sha256-ihyS8MkPFzH9kiKYgNnBrSA/WCTDyaa90Lecp0bj1rw=";
  }
else
