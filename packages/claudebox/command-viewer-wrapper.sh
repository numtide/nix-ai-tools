...
echo "[$(date -Iseconds)] Starting command-viewer wrapper" >> "$wrapper_log"
echo "[$(date -Iseconds)] Arguments: $*" >> "$wrapper_log"
echo "[$(date -Iseconds)] Session: $session_name" >> "$wrapper_log"
