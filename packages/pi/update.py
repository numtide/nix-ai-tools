...
"""Update script for pi package (binary releases)."""
...
def main() -> None:
    ...
    latest = fetch_github_latest_release("badlogic", "pi-mono")
    ...
    url_template = (
        f"https://github.com/badlogic/pi-mono/releases/download/v{latest}/{{platform}}"
    )
