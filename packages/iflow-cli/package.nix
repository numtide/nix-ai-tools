...
buildNpmPackage {
  ...
  meta = {
    description = "A comprehensive command-line intelligence that embeds in your terminal, analyzes repositories, does coding tasks, and boosts efficiency by performing tasks from simple file operations to complex workflow automation";
