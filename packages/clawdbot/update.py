...
"""Update script for clawdbot package."""
...
def main() -> None:
    ...
    tarball_url = f"https://registry.npmjs.org/{NPM_PACKAGE}/-/clawdbot-{latest}.tgz"
    ...
    try:
        npm_deps_hash = calculate_dependency_hash(
            ".#clawdbot", "npmDepsHash", HASHES_FILE, data
        )
