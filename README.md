...
<details>
<summary><strong>happier</strong> - CLI for Happier, a mobile and web client for Claude Code and Codex</summary>

- **Source**: bytecode
- **License**: MIT
- **Homepage**: https://github.com/happier-dev/happier
- **Usage**: `nix run github:numtide/llm-agents.nix#happier -- --help`
- **Nix**: [packages/happier/package.nix](packages/happier/package.nix)
